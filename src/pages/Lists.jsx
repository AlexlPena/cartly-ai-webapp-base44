...
export default function Lists() {
  ...
  const loadLists = useCallback(async () => {
    ...
    const data = await base44.entities.List.filter({ is_archived: false, created_by: user.email }, "-created_date");
    setLists(data || []);
    setLoading(false);
  }, []);
  ...
  return (
    <PullToRefresh onRefresh={loadLists} className="h-[calc(100vh-64px)]">
